...
public class SnakeGame extends JPanel implements ActionListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        ImageIcon izquierda = new ImageIcon(getClass().getResource("izquierda.jpg"));
        ImageIcon derecha = new ImageIcon(getClass().getResource("derecha.jpg"));
        ImageIcon arriba = new ImageIcon(getClass().getResource("arriba.jpg"));
        ImageIcon abajo = new ImageIcon(getClass().getResource("bottom.jpg"));
        ...
        if (isGameRunning) {
            ...
            for (int ind = 0; ind < numSnakeTiles; ind++) {
                ...
                // Paint the head with a special color...
                    if ((ind == 0) && (direction == "left")) {
                       g2d.drawImage(izquierda.getImage(), currentSnakeTile.x, currentSnakeTile.y, TILE_WIDTH, TILE_HEIGHT, null); 
                    } else if ((ind == 0) && (direction == "right")) {
                        g2d.drawImage(derecha.getImage(), currentSnakeTile.x, currentSnakeTile.y, TILE_WIDTH, TILE_HEIGHT, null); 
                    } else if ((ind == 0) && (direction == "up")) {
                        g2d.drawImage(arriba.getImage(), currentSnakeTile.x, currentSnakeTile.y, TILE_WIDTH, TILE_HEIGHT, null); 
                    } else if ((ind == 0) && (direction == "down")) {
                        g2d.drawImage(abajo.getImage(), currentSnakeTile.x, currentSnakeTile.y, TILE_WIDTH, TILE_HEIGHT, null); 
                    }
    ...
    public void checkBoundsCollision() {
        for (int ind = numSnakeTiles; ind > 0; ind--) {
            ...
            if ( (snakeTiles[0].x == snakeTiles[ind].x)
